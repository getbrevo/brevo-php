...
class TransactionalEmailsApi
{
     ...
     *
     * @param  \Brevo\Client\Model\BlockDomain $body body (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function blockNewDomain($body)
    {
        $this->blockNewDomainWithHttpInfo($body);
    }
     ...
     * Add a new domain to the list of blocked domains
     *
     * @param  \Brevo\Client\Model\BlockDomain $body (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function blockNewDomainWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->blockNewDomainRequest($body);
     ...
     */
    public function blockNewDomainAsync($body)
    {
        return $this->blockNewDomainAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blockNewDomainAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->blockNewDomainRequest($body);
     ...
     */
    protected function blockNewDomainRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling blockNewDomain'
            );
        }
     ...
     *
     * @param  \Brevo\Client\Model\CreateSmtpTemplate $body values to update in transactional email template (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Brevo\Client\Model\CreateModel
     */
    public function createSmtpTemplate($body)
    {
        list($response) = $this->createSmtpTemplateWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function createSmtpTemplateWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\CreateModel';
        $request = $this->createSmtpTemplateRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSmtpTemplateAsync($body)
    {
        return $this->createSmtpTemplateAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSmtpTemplateAsyncWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\CreateModel';
        $request = $this->createSmtpTemplateRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createSmtpTemplateRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createSmtpTemplate'
            );
        }
     ...
     * Delete hardbounces
     *
     * @param  \Brevo\Client\Model\DeleteHardbounces $body values to delete hardbounces (optional)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteHardbounces($body = null)
    {
        $this->deleteHardbouncesWithHttpInfo($body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteHardbouncesWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->deleteHardbouncesRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteHardbouncesAsync($body = null)
    {
        return $this->deleteHardbouncesAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteHardbouncesAsyncWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->deleteHardbouncesRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteHardbouncesRequest($body = null)
    {
    ...
    protected function getEmailEventReportRequest($limit = '2500', $offset = '0', $startDate = null, $endDate = null, $days = null, $email = null, $event = null, $tags = null, $messageId = null, $templateId = null, $sort = 'desc')
    {
        ...
        // query params
        if ($templateId !== null) {
            $queryParams['templateId'] = ObjectSerializer::toQueryValue($templateId, 'int64');
        }
        // query params
        if ($sort !== null) {
    ...
    protected function getScheduledEmailByBatchIdRequest($batchId, $startDate = null, $endDate = null, $sort = 'desc', $status = null, $limit = '100', $offset = '0')
    {
        ...
        // query params
        if ($startDate !== null) {
            $queryParams['startDate'] = ObjectSerializer::toQueryValue($startDate, 'date');
        }
        // query params
        if ($endDate !== null) {
            $queryParams['endDate'] = ObjectSerializer::toQueryValue($endDate, 'date');
        }
        // query params
        if ($sort !== null) {
            $queryParams['sort'] = ObjectSerializer::toQueryValue($sort, null);
    ...
    protected function getSmtpTemplatesRequest($templateStatus = null, $limit = '50', $offset = '0', $sort = 'desc')
    {
        ...
        if ($templateStatus !== null) {
            $queryParams['templateStatus'] = ObjectSerializer::toQueryValue($templateStatus, null);
        }
        // query params
        if ($limit !== null) {
            $queryParams['limit'] = ObjectSerializer::toQueryValue($limit, 'int64');
    ...
    protected function getTransacBlockedContactsRequest($startDate = null, $endDate = null, $limit = '50', $offset = '0', $senders = null, $sort = 'desc')
    {
        ...
        // query params
        if (is_array($senders)) {
            $senders = ObjectSerializer::serializeCollection($senders, 'csv', true);
        }
        if ($senders !== null) {
            $queryParams['senders'] = ObjectSerializer::toQueryValue($senders, null);
        }
        // query params
        if ($sort !== null) {
            $queryParams['sort'] = ObjectSerializer::toQueryValue($sort, null);
     ...
     * @return void
     */
    public function sendTestTemplate($body, $templateId)
    {
        $this->sendTestTemplateWithHttpInfo($body, $templateId);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendTestTemplateWithHttpInfo($body, $templateId)
    {
        $returnType = '';
        $request = $this->sendTestTemplateRequest($body, $templateId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTestTemplateAsync($body, $templateId)
    {
        return $this->sendTestTemplateAsyncWithHttpInfo($body, $templateId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTestTemplateAsyncWithHttpInfo($body, $templateId)
    {
        $returnType = '';
        $request = $this->sendTestTemplateRequest($body, $templateId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendTestTemplateRequest($body, $templateId)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendTestTemplate'
            );
        }
        // verify the required parameter 'templateId' is set
        if ($templateId === null || (is_array($templateId) && count($templateId) === 0)) {
     ...
     *
     * @param  \Brevo\Client\Model\SendSmtpEmail $body Values to send a transactional email (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Brevo\Client\Model\CreateSmtpEmail
     */
    public function sendTransacEmail($body)
    {
        list($response) = $this->sendTransacEmailWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function sendTransacEmailWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\CreateSmtpEmail';
        $request = $this->sendTransacEmailRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTransacEmailAsync($body)
    {
        return $this->sendTransacEmailAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendTransacEmailAsyncWithHttpInfo($body)
    {
        $returnType = '\Brevo\Client\Model\CreateSmtpEmail';
        $request = $this->sendTransacEmailRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendTransacEmailRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendTransacEmail'
            );
        }
     ...
     *
     * @param  \Brevo\Client\Model\UpdateSmtpTemplate $body values to update in transactional email template (required)
     * @param  int $templateId id of the template (required)
     *
     * @throws \Brevo\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateSmtpTemplate($body, $templateId)
    {
        $this->updateSmtpTemplateWithHttpInfo($body, $templateId);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSmtpTemplateWithHttpInfo($body, $templateId)
    {
        $returnType = '';
        $request = $this->updateSmtpTemplateRequest($body, $templateId);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSmtpTemplateAsync($body, $templateId)
    {
        return $this->updateSmtpTemplateAsyncWithHttpInfo($body, $templateId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSmtpTemplateAsyncWithHttpInfo($body, $templateId)
    {
        $returnType = '';
        $request = $this->updateSmtpTemplateRequest($body, $templateId);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateSmtpTemplateRequest($body, $templateId)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateSmtpTemplate'
            );
        }
        // verify the required parameter 'templateId' is set
        if ($templateId === null || (is_array($templateId) && count($templateId) === 0)) {
