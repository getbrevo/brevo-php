...
class CreateWhatsAppCampaignRecipients implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['excludedIds'] = isset($data['excludedIds']) ? $data['excludedIds'] : null;
    ...
    {
        return $this->container['excludedIds'];
    }

    /**
     * Sets excludedIds
     *
     * @param int[] $excludedIds List ids to exclude from the campaign
     *
     * @return $this
     */
    public function setExcludedIds($excludedIds)
    {
        $this->container['excludedIds'] = $excludedIds;
