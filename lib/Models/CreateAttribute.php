...
class CreateAttribute implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'value' => 'string',
        'isRecurring' => 'bool',
        'enumeration' => '\Brevo\Client\Models\CreateAttributeEnumeration[]',
        'type' => 'string'
    ];
     ...
     * Gets enumeration
     *
     * @return \Brevo\Client\Models\CreateAttributeEnumeration[]
     */
     ...
     * Sets enumeration
     *
     * @param \Brevo\Client\Models\CreateAttributeEnumeration[] $enumeration List of values and labels that the attribute can take. Use only if the attribute's category is \"category\". For example, [{\"value\":1, \"label\":\"male\"}, {\"value\":2, \"label\":\"female\"}]
     *
     * @return $this
     */
