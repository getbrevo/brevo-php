...
/**
 * CorporateUserEmailPermissionsPutRequest Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CorporateUserEmailPermissionsPutRequest extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_corporate_user__email__permissions_put_request';
    ...
    protected static array $openAPITypes = [
        ...
        'privileges' => '\Brevo\Client\Models\CorporateUserEmailPermissionsPutRequestPrivilegesInner[]'
    ];
    ...
    {
        $this->setIfExists('allFeaturesAccess', $data ?? [], null);
     ...
     * @return bool
     */
    public function getAllFeaturesAccess(): bool
    {
     ...
     * @return $this
     */
    public function setAllFeaturesAccess(bool $allFeaturesAccess): static
    {
        if (is_null($allFeaturesAccess)) {
            throw new InvalidArgumentException('non-nullable allFeaturesAccess cannot be null');
        }
     ...
     * Gets privileges
     *
     * @return \Brevo\Client\Models\CorporateUserEmailPermissionsPutRequestPrivilegesInner[]
     */
     ...
     * Sets privileges
     *
     * @param \Brevo\Client\Models\CorporateUserEmailPermissionsPutRequestPrivilegesInner[] $privileges privileges
     *
     * @return $this
     */
