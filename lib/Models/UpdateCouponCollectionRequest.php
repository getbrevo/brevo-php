...
/**
 * UpdateCouponCollectionRequest Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateCouponCollectionRequest extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateCouponCollection_request';
     ...
     * Sets defaultCoupon
     *
     * @param string|null $defaultCoupon A default coupon to be used in case there are no coupons left
     *
     * @return $this
     */
