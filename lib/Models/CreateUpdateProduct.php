 ...
 */
class CreateUpdateProduct extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createUpdateProduct';
     ...
     * Sets updateEnabled
     *
     * @param bool|null $updateEnabled Facilitate to update the existing category in the same request (updateEnabled = true)
     *
     * @return $this
     */
