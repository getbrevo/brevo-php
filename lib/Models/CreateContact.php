 ...
 */
class CreateContact extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createContact';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('updateEnabled', $data ?? [], false);
     ...
     * Sets email
     *
     * @param string|null $email Email address of the user. **Mandatory if \"ext_id\"  & \"SMS\" field is not passed.**
     *
     * @return $this
     */
     ...
     * Sets extId
     *
     * @param string|null $extId Pass your own Id to create a contact.
     *
     * @return $this
     */
     ...
     * Sets attributes
     *
     * @param array<string,\Brevo\Client\Models\CreateDoiContactAttributesValue>|null $attributes Pass the set of attributes and their values. The attribute's parameter should be passed in capital letter while creating a contact. Values that don't match the attribute type (e.g. text or string in a date attribute) will be ignored. **These attributes must be present in your Brevo account.**. For eg: **{\"FNAME\":\"Elly\", \"LNAME\":\"Roger\", \"COUNTRIES\":[\"India\",\"China\"]}**
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $emailBlacklisted Set this field to blacklist the contact for emails (emailBlacklisted = true)
     *
     * @return $this
     */
     ...
     * Sets smsBlacklisted
     *
     * @param bool|null $smsBlacklisted Set this field to blacklist the contact for SMS (smsBlacklisted = true)
     *
     * @return $this
     */
     ...
     * Sets updateEnabled
     *
     * @param bool|null $updateEnabled Facilitate to update the existing contact in the same request (updateEnabled = true)
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $smtpBlacklistSender transactional email forbidden sender for contact. Use only for email Contact ( only available if updateEnabled = true )
     *
     * @return $this
     */
