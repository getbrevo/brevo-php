...
/**
 * TierForContact Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TierForContact extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tierForContact';
     ...
     * Sets tierId
     *
     * @param string|null $tierId Unique identifier for the assigned tier
     *
     * @return $this
     */
     ...
     * Sets groupId
     *
     * @param string|null $groupId Group Id to which the tier is associated
     *
     * @return $this
     */
     ...
     * Sets contactId
     *
     * @param int|null $contactId Contact to which the tier is assigned
     *
     * @return $this
     */
