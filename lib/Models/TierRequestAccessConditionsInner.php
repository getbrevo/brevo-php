...
/**
 * TierRequestAccessConditionsInner Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class TierRequestAccessConditionsInner extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'tierRequest_accessConditions_inner';
     ...
     *
     * @param string|null $balanceDefinitionId Balance definition identifier for accessing the tier
     *
     * @return $this
     */
     ...
     * Sets minimumValue
     *
     * @param int|null $minimumValue Minimum value required to access the tier
     *
     * @return $this
     */
