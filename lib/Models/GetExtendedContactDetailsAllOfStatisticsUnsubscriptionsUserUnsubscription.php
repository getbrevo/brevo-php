...
/**
 * GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getExtendedContactDetails_allOf_statistics_unsubscriptions_userUnsubscription';
     ...
     * Sets ip
     *
     * @param string|null $ip IP from which the user has unsubscribed
     *
     * @return $this
     */
