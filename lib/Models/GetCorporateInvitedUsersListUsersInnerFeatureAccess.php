...
/**
 * GetCorporateInvitedUsersListUsersInnerFeatureAccess Class Doc Comment
 *
 ...
 */
class GetCorporateInvitedUsersListUsersInnerFeatureAccess extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getCorporateInvitedUsersList_users_inner_feature_access';
     ...
     * Sets userManagement
     *
     * @param string[]|null $userManagement User management accessiblity.
     *
     * @return $this
     */
     ...
     * Sets apiKeys
     *
     * @param string[]|null $apiKeys Api keys accessiblity.
     *
     * @return $this
     */
     ...
     * Sets myPlan
     *
     * @param string[]|null $myPlan My plan accessiblity.
     *
     * @return $this
     */
     ...
     * Sets appsManagement
     *
     * @param string[]|null $appsManagement Apps management accessiblity | Not available in ENTv2
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $subOrganizationGroups Group creation, modification or deletion accessibility
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $createSubOrganizations Authorization to create sub-organization in the admin account. If the user creating the sub-organization, belongs to a group, the user must choose a group at the sub-organization creation.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $manageSubOrganizations Authorization to manage and access sub-organizations in the admin account.
     *
     * @return $this
     */
     ...
     * Sets analytics
     *
     * @param string[]|null $analytics Analytics dashboard accessibility
     *
     * @return $this
     */
     ...
     * Sets security
     *
     * @param string[]|null $security Security page accessibility
     *
     * @return $this
     */
