...
class CreateExternalFeed implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'password' => 'string',
        'token' => 'string',
        'headers' => '\Brevo\Client\Models\GetExternalFeedByUUIDHeaders[]',
        'maxRetries' => 'int',
        'cache' => 'bool'
    ];
     ...
     * Gets headers
     *
     * @return \Brevo\Client\Models\GetExternalFeedByUUIDHeaders[]
     */
     ...
     * Sets headers
     *
     * @param \Brevo\Client\Models\GetExternalFeedByUUIDHeaders[] $headers Custom headers for the feed
     *
     * @return $this
     */
