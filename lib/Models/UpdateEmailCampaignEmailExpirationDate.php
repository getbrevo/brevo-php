...
/**
 * UpdateEmailCampaignEmailExpirationDate Class Doc Comment
 *
 ...
 */
class UpdateEmailCampaignEmailExpirationDate extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateEmailCampaign_emailExpirationDate';
    ...
    public function setDuration(?int $duration): static
    {
        ...
        if (($duration > 3600)) {
            throw new InvalidArgumentException('invalid value for $duration when calling UpdateEmailCampaignEmailExpirationDate., must be smaller than or equal to 3600.');
        }
        if (($duration < 1)) {
            throw new InvalidArgumentException('invalid value for $duration when calling UpdateEmailCampaignEmailExpirationDate., must be bigger than or equal to 1.');
        }
