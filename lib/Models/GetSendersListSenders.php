...
class GetSendersListSenders implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'email' => 'string',
        'active' => 'bool',
        'ips' => '\Brevo\Client\Models\GetSendersListIps[]'
    ];
     ...
     * Gets ips
     *
     * @return \Brevo\Client\Models\GetSendersListIps[]
     */
     ...
     * Sets ips
     *
     * @param \Brevo\Client\Models\GetSendersListIps[] $ips List of dedicated IP(s) available in the account. This data is displayed only for dedicated IPs
     *
     * @return $this
     */
