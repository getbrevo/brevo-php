...
/**
 * UpdateTierGroupRequest Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateTierGroupRequest extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'updateTierGroupRequest';
     ...
     * @return string|null
     */
    public function getTierOrder(): ?string
    {
     ...
     * @return $this
     */
    public function setTierOrder(?string $tierOrder): static
    {
