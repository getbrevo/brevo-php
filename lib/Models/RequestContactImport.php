...
class RequestContactImport implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'fileUrl' => 'string',
        'fileBody' => 'string',
        'jsonBody' => '\Brevo\Client\Models\RequestContactImportJsonBody[]',
        'listIds' => 'int[]',
        'notifyUrl' => 'string',
     ...
     * Gets jsonBody
     *
     * @return \Brevo\Client\Models\RequestContactImportJsonBody[]
     */
     ...
     * Sets newList
     *
     * @param \Brevo\Client\Models\RequestContactImportNewList $newList newList
     *
     * @return $this
     */
