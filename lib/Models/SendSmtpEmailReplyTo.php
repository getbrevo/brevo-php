 ...
 */
class SendSmtpEmailReplyTo extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'sendSmtpEmail_replyTo';
     ...
     * Sets name
     *
     * @param string|null $name Name in reply to. **Maximum allowed characters are 70**.
     *
     * @return $this
     */
