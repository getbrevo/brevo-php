...
/**
 * ConversationsMessagesPostRequest Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ConversationsMessagesPostRequest extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_conversations_messages_post_request';
     ...
     * Sets agentEmail
     *
     * @param mixed|null $agentEmail agent email. When sending messages from a standalone system, it’s hard to maintain a 1-to-1 relationship between the users of both systems. In this case, an agent can be specified by their email address.
     *
     * @return $this
     */
