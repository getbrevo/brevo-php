 ...
 */
class GetSharedTemplateUrl extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getSharedTemplateUrl';
    ...
    {
        $this->setIfExists('sharedUrl', $data ?? [], null);
    }
     ...
     * @return $this
     */
    public function setSharedUrl(string $sharedUrl): static
    {
        if (is_null($sharedUrl)) {
            throw new InvalidArgumentException('non-nullable sharedUrl cannot be null');
        }
