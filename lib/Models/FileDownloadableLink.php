 ...
 */
class FileDownloadableLink extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FileDownloadableLink';
     ...
     * Sets fileUrl
     *
     * @param string|null $fileUrl A unique link to download the requested file.
     *
     * @return $this
     */
