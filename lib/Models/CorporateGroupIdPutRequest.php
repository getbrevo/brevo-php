...
/**
 * CorporateGroupIdPutRequest Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CorporateGroupIdPutRequest extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = '_corporate_group__id__put_request';
     ...
     * Sets groupName
     *
     * @param string|null $groupName The name of the group of sub-accounts
     *
     * @return $this
     */
     ...
     * Sets subAccountIds
     *
     * @param int[]|null $subAccountIds Pass the list of sub-account Ids to be included in the group
     *
     * @return $this
     */
