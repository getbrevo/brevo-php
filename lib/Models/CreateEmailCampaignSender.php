 ...
 */
class CreateEmailCampaignSender extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'createEmailCampaign_sender';
     ...
     * Sets id
     *
     * @param int|null $id Select the sender for the campaign on the basis of sender id. _In order to select a sender with specific pool of IP’s, dedicated ip users shall pass id (instead of email)_.
     *
     * @return $this
     */
