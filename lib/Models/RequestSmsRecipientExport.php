 ...
 */
class RequestSmsRecipientExport extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'requestSmsRecipientExport';
    ...
    public const RECIPIENTS_TYPE_DELIVERED = 'delivered';
    public const RECIPIENTS_TYPE_ANSWERED = 'answered';
     ...
     * Sets notifyURL
     *
     * @param string|null $notifyURL URL that will be called once the export process is finished. For reference, https://help.brevo.com/hc/en-us/articles/360007666479
     *
     * @return $this
     */
