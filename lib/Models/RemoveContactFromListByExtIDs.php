...
/**
 * RemoveContactFromListByExtIDs Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RemoveContactFromListByExtIDs extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'removeContactFromListByExtIDs';
    ...
    public function setExtIds(?array $extIds): static
    {
        ...
        if ((count($extIds) > 150)) {
            throw new InvalidArgumentException('invalid value for $extIds when calling RemoveContactFromListByExtIDs., number of items must be less than or equal to 150.');
        }
        if ((count($extIds) < 1)) {
            throw new InvalidArgumentException('invalid length for $extIds when calling RemoveContactFromListByExtIDs., number of items must be greater than or equal to 1.');
        }
