...
/**
 * RemoveContactFromListByEmails Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RemoveContactFromListByEmails extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'removeContactFromListByEmails';
    ...
    public function setEmails(?array $emails): static
    {
        ...
        if ((count($emails) > 150)) {
            throw new InvalidArgumentException('invalid value for $emails when calling RemoveContactFromListByEmails., number of items must be less than or equal to 150.');
        }
        if ((count($emails) < 1)) {
            throw new InvalidArgumentException('invalid length for $emails when calling RemoveContactFromListByEmails., number of items must be greater than or equal to 1.');
        }
