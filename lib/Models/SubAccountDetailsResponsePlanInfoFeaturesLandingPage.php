 ...
 */
class SubAccountDetailsResponsePlanInfoFeaturesLandingPage extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'subAccountDetailsResponse_planInfo_features_landingPage';
     ...
     * Sets quantity
     *
     * @param int|null $quantity Quantity of landing pages provided
     *
     * @return $this
     */
     ...
     * Sets remaining
     *
     * @param int|null $remaining Available landing pages for use
     *
     * @return $this
     */
