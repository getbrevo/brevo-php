...
class SendSmtpEmail implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bcc' => '\Brevo\Client\Models\SendSmtpEmailBcc[]',
        'cc' => '\Brevo\Client\Models\SendSmtpEmailCc[]',
        'htmlContent' => 'string',
        'textContent' => 'string',
        'subject' => 'string',
        'replyTo' => '\Brevo\Client\Models\SendSmtpEmailReplyTo',
        'attachment' => '\Brevo\Client\Models\SendSmtpEmailAttachment[]',
        'headers' => 'object',
        'templateId' => 'int',
        'params' => 'object',
        'messageVersions' => '\Brevo\Client\Models\SendSmtpEmailMessageVersions[]',
        'tags' => 'string[]',
     ...
     * Sets sender
     *
     * @param \Brevo\Client\Models\SendSmtpEmailSender $sender sender
     *
     * @return $this
     */
     ...
     * Gets to
     *
     * @return \Brevo\Client\Models\SendSmtpEmailTo[]
     */
     ...
     * Sets to
     *
     * @param \Brevo\Client\Models\SendSmtpEmailTo[] $to Mandatory if messageVersions are not passed, ignored if messageVersions are passed. List of email addresses and names (optional) of the recipients. For example, [{\"name\":\"Jimmy\", \"email\":\"jimmy98@example.com\"}, {\"name\":\"Joe\", \"email\":\"joe@example.com\"}]
     *
     * @return $this
     */
     ...
     * Gets bcc
     *
     * @return \Brevo\Client\Models\SendSmtpEmailBcc[]
     */
     ...
     * Sets bcc
     *
     * @param \Brevo\Client\Models\SendSmtpEmailBcc[] $bcc List of email addresses and names (optional) of the recipients in bcc
     *
     * @return $this
     */
     ...
     * Gets cc
     *
     * @return \Brevo\Client\Models\SendSmtpEmailCc[]
     */
     ...
     * Sets cc
     *
     * @param \Brevo\Client\Models\SendSmtpEmailCc[] $cc List of email addresses and names (optional) of the recipients in cc
     *
     * @return $this
     */
     ...
     * Gets replyTo
     *
     * @return \Brevo\Client\Models\SendSmtpEmailReplyTo
     */
     ...
     * Sets replyTo
     *
     * @param \Brevo\Client\Models\SendSmtpEmailReplyTo $replyTo replyTo
     *
     * @return $this
     */
     ...
     * Gets attachment
     *
     * @return \Brevo\Client\Models\SendSmtpEmailAttachment[]
     */
     ...
     *
     * @return \Brevo\Client\Models\SendSmtpEmailMessageVersions[]
     */
