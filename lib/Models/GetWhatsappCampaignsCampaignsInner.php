...
/**
 * GetWhatsappCampaignsCampaignsInner Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetWhatsappCampaignsCampaignsInner extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getWhatsappCampaigns_campaigns_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('invalidatedContacts', $data ?? [], null);
        $this->setIfExists('readPercentage', $data ?? [], null);
     ...
     * Sets errorReason
     *
     * @param string|null $errorReason Error Reason associated with the WhatsApp campaign sending
     *
     * @return $this
     */
     ...
     * @return int|null
     */
    public function getInvalidatedContacts(): ?int
    {
     ...
     *
     * @param int|null $invalidatedContacts Count of invalidated contacts
     *
     * @return $this
     */
    public function setInvalidatedContacts(?int $invalidatedContacts): static
    {
        if (is_null($invalidatedContacts)) {
            throw new InvalidArgumentException('non-nullable invalidatedContacts cannot be null');
        }
     ...
     * Sets readPercentage
     *
     * @param float|null $readPercentage Read percentage of the the WhatsApp campaign created
     *
     * @return $this
     */
    public function setReadPercentage(?float $readPercentage): static
    {
        if (is_null($readPercentage)) {
            throw new InvalidArgumentException('non-nullable readPercentage cannot be null');
        }
