...
/**
 * GetAllExternalFeedsFeedsInner Class Doc Comment
 *
 * @package  Brevo\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetAllExternalFeedsFeedsInner extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getAllExternalFeeds_feeds_inner';
    ...
    public function setMaxRetries(int $maxRetries): static
    {
        ...
        if (($maxRetries > 5)) {
            throw new InvalidArgumentException('invalid value for $maxRetries when calling GetAllExternalFeedsFeedsInner., must be smaller than or equal to 5.');
        }
        if (($maxRetries < 0)) {
            throw new InvalidArgumentException('invalid value for $maxRetries when calling GetAllExternalFeedsFeedsInner., must be bigger than or equal to 0.');
        }
