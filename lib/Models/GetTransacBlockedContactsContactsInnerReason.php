...
/**
 * GetTransacBlockedContactsContactsInnerReason Class Doc Comment
 *
 ...
 */
class GetTransacBlockedContactsContactsInnerReason extends AbstractModel
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'getTransacBlockedContacts_contacts_inner_reason';
     ...
     * Sets code
     *
     * @param string|null $code Reason code for blocking / unsubscribing (This code is safe for comparison)
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string|null $message Reason for blocking / unsubscribing (This string is not safe for comparison)
     *
     * @return $this
     */
