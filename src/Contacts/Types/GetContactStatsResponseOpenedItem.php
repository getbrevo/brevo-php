...
class GetContactStatsResponseOpenedItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var int $count Number of openings of the campaign
     */
    #[JsonProperty('count')]
    public int $count;
    ...
    /**
     * @var string $ip IP from which the user has opened the campaign
     */
    #[JsonProperty('ip')]
    public string $ip;
