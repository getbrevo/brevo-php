...
class GetProcessesResponseProcessesItem extends JsonSerializableType
{
    ...
    /**
     * @var ?GetProcessesResponseProcessesItemInfo $info Additional process information, only returned for completed IMPORTUSER processes. Contains URLs to CSV files with details about problematic records.
     */
    #[JsonProperty('info')]
