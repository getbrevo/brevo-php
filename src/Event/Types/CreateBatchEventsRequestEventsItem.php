...
class CreateBatchEventsRequestEventsItem extends JsonSerializableType
{
    /**
     * @var ?array<string, (
     *    string
    ...
    /**
     * @var CreateBatchEventsRequestEventsItemIdentifiers $identifiers Identifies the contact associated with the event. At least one identifier is required.
     */
    #[JsonProperty('identifiers')]
    public CreateBatchEventsRequestEventsItemIdentifiers $identifiers;

    /**
     * @var ?CreateBatchEventsRequestEventsItemObject $object Identifiers of the object record associated with this event. Ignored if the object type or identifier for this record does not exist on the account.
     */
    #[JsonProperty('object')]
    public ?CreateBatchEventsRequestEventsItemObject $object;
     ...
     *   |array<mixed>
     * )>,
     *   object?: ?CreateBatchEventsRequestEventsItemObject,
     * } $values
     */
