...
use Brevo\SmsCampaigns\Types\UpdateSmsCampaignRequestRecipients;

class UpdateSmsCampaignRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?UpdateSmsCampaignRequestRecipients $recipients
     */
    #[JsonProperty('recipients')]
    public ?UpdateSmsCampaignRequestRecipients $recipients;
