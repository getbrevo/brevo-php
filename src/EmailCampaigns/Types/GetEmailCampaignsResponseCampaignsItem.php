...
class GetEmailCampaignsResponseCampaignsItem extends JsonSerializableType
{
    ...
    /**
     * @var value-of<GetEmailCampaignsResponseCampaignsItemStatus> $status Status of the campaign
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<GetEmailCampaignsResponseCampaignsItemType> $type Type of campaign
     */
    #[JsonProperty('type')]
    public string $type;
    ...
    /**
     * @var GetEmailCampaignsResponseCampaignsItemSender $sender
     */
    #[JsonProperty('sender')]
    public GetEmailCampaignsResponseCampaignsItemSender $sender;
     ...
     *   id: int,
     *   name: string,
     *   status: value-of<GetEmailCampaignsResponseCampaignsItemStatus>,
     *   type: value-of<GetEmailCampaignsResponseCampaignsItemType>,
     *   createdAt: string,
     *   footer: string,
     *   header: string,
     *   htmlContent: string,
