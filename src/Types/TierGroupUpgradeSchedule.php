 ...
 */
class TierGroupUpgradeSchedule extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<TierGroupUpgradeScheduleDurationUnit> $durationUnit Duration unit for the schedule.
     */
    #[JsonProperty('durationUnit')]
    public ?string $durationUnit;

    /**
     * @var ?value-of<TierGroupUpgradeScheduleDurationModifier> $durationModifier Modifier for the duration.
     */
     ...
     *   strategy?: ?string,
     *   durationValue?: ?int,
     *   durationUnit?: ?value-of<TierGroupUpgradeScheduleDurationUnit>,
     *   durationModifier?: ?value-of<TierGroupUpgradeScheduleDurationModifier>,
