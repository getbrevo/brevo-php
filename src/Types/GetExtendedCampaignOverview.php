...
class GetExtendedCampaignOverview extends JsonSerializableType
{
    ...
    /**
     * @var value-of<GetExtendedCampaignOverviewStatus> $status Status of the campaign
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var value-of<GetExtendedCampaignOverviewType> $type Type of campaign
     */
    #[JsonProperty('type')]
    public string $type;
    ...
    /**
     * @var GetExtendedCampaignOverviewSender $sender
     */
    #[JsonProperty('sender')]
    public GetExtendedCampaignOverviewSender $sender;
     ...
     *   id: int,
     *   name: string,
     *   status: value-of<GetExtendedCampaignOverviewStatus>,
     *   type: value-of<GetExtendedCampaignOverviewType>,
     *   createdAt: string,
     *   footer: string,
     *   header: string,
     *   htmlContent: string,
